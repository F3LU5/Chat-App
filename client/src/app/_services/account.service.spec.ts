...
describe('AccountService', () => {
  ...
  beforeEach(() => {
    const spy = jasmine.createSpyObj('PresenceService', ['createHubConnection', 'stopHubConnection']);
  ...
  it('powinien się zalogować i ustawić bieżącego użytkownika', () => {
    ...
    expect(mockPresenceService.createHubConnection).toHaveBeenCalledWith(mockUser);
  });
